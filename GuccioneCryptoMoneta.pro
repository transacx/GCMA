TEMPLATE = app
TARGET = guccionecryptomoneta-qt
macx:TARGET = "GuccioneCryptoMoneta-Qt"
VERSION = 0.8.7.5
...
QT += testlib
TARGET = guccionecryptomoneta-qt_test
...
macx:ICON = src/qt/res/icons/guccionecryptomoneta.icns
