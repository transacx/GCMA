...
#if defined(NDEBUG)
# error "GuccioneCryptoMoneta cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x461e4f480fdd93fe2c28a9cc9433bc46c2e32d51b976c41a0582af072bf212eb");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // GuccioneCryptoMoneta: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "GuccioneCryptoMoneta Signed Message:\n";
...
{
    // GuccioneCryptoMoneta: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // GuccioneCryptoMoneta: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // GuccioneCryptoMoneta: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x461e4f480fdd93fe2c28a9cc9433bc46c2e32d51b976c41a0582af072bf212eb");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1434271478, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "14/Jun/2015 Jun 12 2015 Crypto Gained A New Player";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x65f95a4b5401ca83d876b21f743ba381ad9fee9ed5f813b45c6de0a27cac9c26"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // GuccioneCryptoMoneta: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("GuccioneCryptoMonetaMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GuccioneCryptoMonetaMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GuccioneCryptoMonetaMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static GuccioneCryptoMonetaMiner(CWallet *pwallet)
{
    printf("GuccioneCryptoMonetaMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("guccionecryptomoneta-miner");
    ...
    try { loop {
        ...
        printf("Running GuccioneCryptoMonetaMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("GuccioneCryptoMonetaMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&GuccioneCryptoMonetaMiner, pwallet));
}
